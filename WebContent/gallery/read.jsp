...
gbean = gdao.getGallery(num);
gdao.updateReadCount(num);

String gid = gbean.getId();
...
List<CommentBean> c = cdao.getCommentList(num,"gallery");
          ...
          <form action="edit.jsp" method="post" role="form" name="f">
               ...
               <!-- 다운로드 -->
                 <%
	                ...
	                %>
                <div class="col-md-12 form-group">
                	<a href='filedownload.jsp?fileName=<%=gbean.getFile()%>'><%=gbean.getFile_name()%></a>
				</div>
              	<%
	                }%>
                ...
                <% } %>
                <div class="col-md-12 form-group">
                  <input type="button" class="readmore d-block w-50" value="목록" onclick="location.href='gallery.jsp'"></td>
